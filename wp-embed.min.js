 !function(d, l) {
   ...
   if (d.wp=d.wp || {}
      ...
      ,
       !d.wp.receiveEmbedMessage) if (d.wp.receiveEmbedMessage=function(e) {
         var t=e.data;
         ...
         if (t) if (t.secret || t.message || t.value) if ( !/[^a-zA-Z0-9]/.test(t.secret)) {
            ...
            for (r=0; r < o.length; r++) if (a=o[r],
               ...
               if ("link"===t.message) if (s=l.createElement("a"),
                  n=l.createElement("a"),
      ...
      ,
      e) d.addEventListener("message", d.wp.receiveEmbedMessage,  !1),
   ...
   function t() {
      if ( !o) {
         ...
         for (t=0; t < n.length; t++) {
            if ( !(r=n[t]).getAttribute("data-secret")) a=Math.random().toString(36).substr(2, 10),
            r.src+="#?secret="+a,
            r.setAttribute("data-secret", a);
            if (i || s) (e=r.cloneNode( !0)).removeAttribute("security"),
